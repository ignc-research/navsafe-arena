...
class MLP_LSTM(nn.Module):
    ...
    def __init__(
        ...
        self.body_net_lstm = nn.LSTM(input_size=human_state_size, hidden_size=HIDDEN_SHAPE_LSTM)
...
class MLP_GRU(nn.Module):
    ...
    def __init__(
        ...
        self.body_net_gru = nn.GRU(input_size=human_state_size, hidden_size=HIDDEN_SHAPE_GRU)
